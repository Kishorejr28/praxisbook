...
// Floating "Powered by PraxisBook" watermark badge.
...
export function PraxisBookBadge({ demo = false }: Props) {
  if (demo) {
    return (
      <>
        ...
        >
          ...
          <span>Demo · Powered by <strong>PraxisBook</strong></span>
  ...
  return (
    ...
    >
      ...
      Powered by <strong className="text-gray-600 ml-0.5">PraxisBook</strong>
    </a>
  );
}
